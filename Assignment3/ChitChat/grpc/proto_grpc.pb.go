...
type ChitChatClient interface {
	JoinChat(ctx context.Context, in *User, opts ...grpc.CallOption) (*Empty, error)
	LeaveChat(ctx context.Context, in *User, opts ...grpc.CallOption) (*Empty, error)
	SendMessage(ctx context.Context, in *ChitChatMessage, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *chitChatClient) JoinChat(ctx context.Context, in *User, opts ...grpc.CallOption) (*Empty, error) {
...
func (c *chitChatClient) SendMessage(ctx context.Context, in *ChitChatMessage, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type ChitChatServer interface {
	JoinChat(context.Context, *User) (*Empty, error)
	LeaveChat(context.Context, *User) (*Empty, error)
	SendMessage(context.Context, *ChitChatMessage) (*Empty, error)
...
func (UnimplementedChitChatServer) JoinChat(context.Context, *User) (*Empty, error) {
...
func (UnimplementedChitChatServer) SendMessage(context.Context, *ChitChatMessage) (*Empty, error) {
...
func _ChitChat_JoinChat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChitChatServer).JoinChat(ctx, req.(*User))
	}
...
func _ChitChat_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChitChatServer).SendMessage(ctx, req.(*ChitChatMessage))
	}
	return interceptor(ctx, in, info, handler)
}
